...
import AddProductRequests from '../../../Models/AddProductRequests';
...
export const AddNewProduct = () => {
    ...
    async function submitNewProduct(){
        ...
        if(authState?.isAuthenticated && title!==''&& artist!==''&& category!=='Category' && productDescription!==''&& quantities>=0){
            const product: AddProductRequests=new AddProductRequests(title,artist,productDescription,quantities,category);
